...
# Reference: https://github.com/ml-research/Q16/blob/main/data/ViT-L-14/prompts.p
script_dir = os.path.dirname(__file__)
q16_file = os.path.join(script_dir, 'q16_prompts.p')

def load_prompts(device):
    return torch.FloatTensor(pickle.load(open(q16_file, 'rb'))).to(device)
...
class Q16():
    def __init__(self):
        ...
        self.model = CLIPVisionModelWithProjection.from_pretrained("/root/experiment/SPM/.cache/hub/models--openai--clip-vit-large-patch14/snapshots/32bd64288804d66eefd0ccbe215aa642df71cc41").to(self.torch_device)
        self.processor = CLIPImageProcessor.from_pretrained("/root/experiment/SPM/.cache/hub/models--openai--clip-vit-large-patch14/snapshots/32bd64288804d66eefd0ccbe215aa642df71cc41")
